This project is about learning to import and use functions and create modules in Python. I further practiced using the built-in function dir() and using command-line arguments within Python programs.
